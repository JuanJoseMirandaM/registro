...
class ControladorUsuarios{
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						echo '<br><div class="alert alert-danger">Error al ingresar, vuelva a intentar</div>';
					}
				}else{
						echo '<br><div class="alert alert-danger">Error el usuario no esta activado</div>';
					}
	...
	static public function ctrCrearUsuario(){
		if (isset($_POST["nuevoUsuario"])) {
			if(preg_match('/^[0-9]+$/', $_POST["nuevoCi"]) &&
			   ...
			   preg_match('/^[0-9-]+$/', $_POST["nuevoFono"])){
			   	...
			   	if(isset($_FILES["nuevaFoto"]["tmp_name"])){
			   		...
			   		mkdir($directorio, 0755);
			   		 ...
			   		 /*==============================================================
			   		 =DE ACUEROD CON EL TIPO DE IMAGEN APLICAMOS LAS FUNCIONES POR DEFECTO=
			   		 ==============================================================*/
